...
| CSI ? 15 n | Reply that no printer is ready |
| CSI ? 25 n | Reply that user-defined keys are locked |
...
| CSI ? 66 h / l | Enable / disable the [application keypad](application-keypad.md) |
| CSI ? 67 h / l | Make the [Backspace key](backarrow-key.md) send BS / DEL |
| CSI ? 1048 h / l | [Save / restore cursor state](cursor.md) through the shared DECSC slot |
| CSI ? 47/1047/1049 h / l | Select the [alternate screen](alternate-screen.md) with mode-specific clear/save rules |
