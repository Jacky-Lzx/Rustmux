...
def identity_flood():
    data = b"\x1b[c\x1b[>c\x1b[=c\x1b[>q\x1b[18t\x1b[\"v" * 10000
    while data:
        data = data[os.write(1, data):]
writer = threading.Thread(target=identity_flood)
writer.start()
time.sleep(0.1)
receive(b"\x1b[?1;0c\x1b[>0;0;0c\x1bP!|00000000\x1b\\\x1bP>|rustmux(0.1.0)\x1b\\\x1b[8;20;78t\x1b[20;78;1;1;1\"w" * 10000)
writer.join(timeout=2)
assert not writer.is_alive()
