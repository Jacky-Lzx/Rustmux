...
os.write(1, b"\x1b]10;#010203\x1b\\\x1b]11;rgb:1111/2222/3333\x07\x1b]10;?\x1b\\\x1b]11;?\x07")
receive(b"\x1b]10;rgb:0101/0202/0303\x1b\\\x1b]11;rgb:1111/2222/3333\x07")
...
writer.join(timeout=2)
assert not writer.is_alive()
os.write(1, b"\x1b[c\x1b[0c\x1bZ\x1b[>c\x1b[>0c")
receive(b"\x1b[?1;0c" * 3 + b"\x1b[>0;0;0c" * 2)
def identity_flood():
    data = b"\x1b[c\x1b[>c" * 10000
    while data:
        data = data[os.write(1, data):]
writer = threading.Thread(target=identity_flood)
writer.start()
time.sleep(0.1)
receive(b"\x1b[?1;0c\x1b[>0;0;0c" * 10000)
writer.join(timeout=2)
assert not writer.is_alive()
